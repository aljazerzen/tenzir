...
struct proxy_settings {
  ...
  /// Convenience-split fields for chokepoints that build
  /// `Proxy-Authorization` themselves (Proxygen direct connect).
  ...
  /// Comma-separated host list matched by `bypass_proxy`.
